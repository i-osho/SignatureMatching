...
def predict_signatures(model, img_path1, img_path2, image_size=(224, 224)):
    ...
    # Make prediction
    prediction = model.predict([img1, img2])[0][0]  # best_80.keras
...
class SignatureMatcherGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Signature Matching Tool - best_80.keras")
    ...
    def load_model(self):
        ...
        try:
            self.model = tf.keras.models.load_model(f"{root_path}/models/best_80.keras")
